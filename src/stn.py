...
fname_param = os.path.join('{}_pred{}123.best.h5'.format(modelbase, predstep))
print((fname_param))
...
model.fit([trainX], trainY, epochs=nb_epoch, batch_size=bs, verbose=verbose, callbacks=[early_stopping, model_checkpoint])
